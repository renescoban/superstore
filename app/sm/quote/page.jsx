...
const randQuote = () => {
    ...
    function handleClick() {
        ...
        setItem({
            author: quotes[rando].author,
            quote: quotes[rando].quote,
            color: getRandomColor(),
        })
    ...
    return (
        <div className="container flex flex-col items-center justify-center h-[65vh]">
            <div className="flex justify-center text-center mb-12 px-8" ><div className="p-3 rounded-md" style={asd}>
                <button className='bg-white rounded-xl  px-5 border' onClick={handleClick}>New Quote</button>
            </div>
        </div>
