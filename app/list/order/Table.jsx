            ...
            <div className='overflow-x-auto '>
                <table className=' bg-white text-left border m-1 '>
                    <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                        ...
                        <input type="text" id="table-search" class="block p-2  text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items" />
                    ...
                    <tbody>
                        <tr className='border-b transition duration-300 ease-in-out hover:bg-neutral-100'>
                            ...
                            <td className="px-6 py-4 "> <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a></td>
                        </tr>
                        <tr className='border-b transition duration-300 ease-in-out hover:bg-neutral-100'>
                            <td class="w-4 p-4">
                                <div class="flex items-center">
